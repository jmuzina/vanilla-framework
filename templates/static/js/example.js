(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    var scriptEmbeds = document.querySelectorAll('.js-embed-script[data-script-path]');

    [].slice.call(examples).forEach(fetchExample);
    [].slice.call(scriptEmbeds).forEach(fetchScript);
  });
  ...
  /**
   * Fetches a script from the given URL and renders it in the page.
   * @param {HTMLScriptElement} scriptElement
   */
  function fetchScript(scriptElement) {}
